...
type Config struct {
	...
	ExcludedUids []uint32 `protobuf:"varint,8,rep,packed,name=excluded_uids,json=excludedUids,proto3" json:"excluded_uids,omitempty"`
	...
	AllowedUids []uint32 `protobuf:"varint,9,rep,packed,name=allowed_uids,json=allowedUids,proto3" json:"allowed_uids,omitempty"`
...
func (x *Config) GetExcludedUids() []uint32 {
	if x != nil {
		return x.ExcludedUids
	}
	return nil
}

func (x *Config) GetAllowedUids() []uint32 {
	if x != nil {
		return x.AllowedUids
	}
	return nil
}

func (x *Config) GetUidLookupTimeoutMs() uint32 {
	if x != nil {
		return x.UidLookupTimeoutMs
	}
	return 0
}
...
const file_proxy_tun_config_proto_rawDesc = "" +
	...
	"\x18auto_outbounds_interface\x18\a \x01(\tR\x16autoOutboundsInterface\x12#\n" +
